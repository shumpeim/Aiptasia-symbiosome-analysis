Aiptasia_only_search_Bmin_removed
================
Shumpei Maruyama
2026-03-02

- [Aiptasia genome only search with algal peptides
  removed](#aiptasia-genome-only-search-with-algal-peptides-removed)
...
![](Aiptasia_only_search_Bmin_removed_files/figure-gfm/volcano_plot-1.png)<!-- -->
...
![](Aiptasia_only_search_Bmin_removed_files/figure-gfm/pca_plot-1.png)<!-- -->
...
![](Aiptasia_only_search_Bmin_removed_files/figure-gfm/GO_Term_plot-1.png)<!-- -->
...
```
    ...
    ## [1] "Proportion of SAG proteins is: 0.196969696969697 %"
...
```
    ...
    ## [1] "Proportion of SAG proteins is: 0.109845402766477 %"
...
```
    ...
    ## [1] "Proportion of TM proteins is: 0.303030303030303 %"
...
```
    ...
    ## [1] "Proportion of TM proteins is: 0.139137510170871 %"
...
![](Aiptasia_only_search_Bmin_removed_files/figure-gfm/SAG_TM_plot-1.png)<!-- -->
