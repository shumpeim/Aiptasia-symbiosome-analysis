...
The repository also contains several additional analyses done to assess the contribution of _Breviolum minutum_ peptides and the effect of database size to the results reported in the manuscript. These analyses and conclusions are described in detail below.
